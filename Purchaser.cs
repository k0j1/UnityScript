...
public class Purchaser : MonoBehaviour, IStoreListener
{
	...
	private static string kProductIDConsumable = "item1000pt";                                                     // 消費型製品の汎用ID
	...
	private static string kProductNameGooglePlayConsumable = "com.takaharabooks.peconekoproject.item1000pt";    // Google Play Store identifier for the consumable product.
	private static string kProductNameGooglePlayNonConsumable = "com.takaharabooks.PecoNekoProject.nonconsumable"; // Google Play Store identifier for the non-consumable product.
	private static string kProductNameGooglePlaySubscription = "com.takaharabooks.PecoNekoProject.subscription";  // Google Play Store identifier for the subscription product.

	public int m_nPurGetPoint = 1000;
	public UnityAds m_Ads = null;

	const string API_KEY = "";
	...
	public void InitializePurchasing()
	{
        ...
        {
			var moduleG = StandardPurchasingModule.Instance();
			var builderG = ConfigurationBuilder.Instance(moduleG);
			//var builder = ConfigurationBuilder.Instance(Google.Play.Billing.GooglePlayStoreModule.Instance());
			builderG.Configure<IGooglePlayConfiguration>().SetPublicKey(API_KEY);
			builderG.AddProduct(kProductIDConsumable, ProductType.Consumable, new IDs()
			{
				{ kProductNameGooglePlayConsumable,  GooglePlay.Name }
			});
			UnityPurchasing.Initialize(this, builderG);
			return;
		}
